            ...
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 bold-Inter">
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <DialogTitle as="h3" className="text-base font-semibold leading-6 text-gray-900 text-3xl ">
                    {title}
                  </DialogTitle>
                  <div className="m-2 mt-5 ">
                    <p className="text-2xl "><span className=" text-gray-500">Title :</span> {taskTitle}</p>
                  </div>
                  <div className="m-2">
                    <p className="text-md text-gray-500">Description : {content}</p>
                  </div>
                  <div className="m-2">
